 const countries_data = [
  ...
  //1
//   let onlynames=countries_data.sort((a,b)=>b.name.localeCompare(a.name))
//   console.log(onlynames)
  //2
//   let onlyarea=countries_data.sort((a,b)=>a.area-b.area).slice(0,10)
//   console.log(onlyarea);
  //3
//   let onlypopulation=countries_data.sort((a,b)=>a.population-b.population).slice(0,10)
//   console.log(onlypopulation);
  //4
//   let englishlanguage=countries_data.filter((element)=>element.languages.toString() ==="English" ?element.languages :null)
//   let englishlanguage=countries_data.filter((element)=>element.languages.includes("English") ?element.languages :null)
//   console.log(englishlanguage);
//5
//   let regionAE=countries_data.filter((element)=>element.region.includes("Asia") || element.region.includes("Europe") )
//   console.log(regionAE);
//6
// let mainLanguage=countries_data.filter((element)=>element.languages.length>1 )
